...
<head>
    ...
    <style>
        ...
        #customers tr:nth-child(even){background-color: #fde8ea;}
        #customers th {padding-top: 6px;padding-bottom: 6px;background-color: #4c0209;color: #ffffff;}
...
<body>
    ...
    <?php 
        ...
        { 
            ...
            <p ><h3 style="text-align:center;">GATE 2025 <?php echo $row1["adexamcity"]; ?> city Centre details -Week 2</h3></p>
            <table id="customers">
                    ...
                    while($row2 = mysqli_fetch_array($centdet)) 
                        { ?>
                            ...
                            <?php
                                ...
                                $irdet = mysqli_query($connect,"SELECT * FROM `irdetails` where ir_allotted_city ='$mg_city' and ir_allotted_centre_code='$cc_code' and ir_exam_S in ('W2-GATE','W2-D4-GATE','W2-D3-GATE') ");
