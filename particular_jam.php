...
<style> #bothir {border-collapse: collapse;width: 100%;margin:auto;line-height: 1.8;}#bothir td, #bothir th { line-height: 1.8;border: 1px solid #ddd;border-color:darkred;padding: 8px;}#bothir tr:nth-child(even){background-color: #F4ECF7;}#bothir th {padding-top: 6px;padding-bottom: 6px;background-color: blue ;color: whitesmoke;}
...
$result2 = mysqli_query($connect,"SELECT * FROM exam_center_details where is_jam ='Y' and center_name <> 'GATE Office'");
...
<h3 style="text-align:center; color:brown;">
  ...
  $g_code = $row2['center_code'];
	...
	$ccol = '';
	$ccol1 = '';
	if($row2['is_one_w1'] =='Y' && $row2['ses1'] == 0){
		$ccol = 'red';
		$ccol1 = '[One Day : Sunday] ' ;
	}
	if($row2['is_one_w1'] =='Y' && $row2['ses3'] == 0){
		$ccol = 'green';
...
<table id="bothir" >
<tr>
<th width="150px">JAM 2024<br><img src="IIT_Madras-2.png" width="50px" height="50px"><br>IIT Madras</th>
<th>
<?php echo $row2['center_name'];?> - <?php echo $row2['c_city'];?>
</th>

<th width="100px">
<?php echo $row2['j_c_code'];?>
</th>
</tr>
<tr>
