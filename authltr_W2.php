...
<head>
    ...
    <title>Authority Letter Week2</title>
    <style>
        ...
        .container {  position: relative;  text-align: center;  color: green;font-size: 16px;} 
   </style>
</head>
<body>
    <?php
        ...
        foreach ($dataArray as $row ) {
            if($row['is_w2']=="Y"){
                ...
                echo "<h4>". htmlspecialchars($row['g_code']) . "-" . htmlspecialchars($row['Center Name']) ." Week2</h4>";
