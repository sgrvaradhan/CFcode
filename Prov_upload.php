...
<div class="row">
    ...
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form action="import.php" method="post" class="row g-2 float-end" enctype="multipart/form-data">
            ...
            <div class="col-auto">
                <input type="submit" class="btn btn-success mb-3" name="importProv" value="Import CSV">
            </div>
    ...
    <form action="import.php" method="post">
            <div class="col-auto">
                <input type="submit" class="btn btn-success mb-3" name="DeleteEntry" value="Clean the table">
            </div>
        </form>
    <!-- Data list table --> 
    <table class="table table-striped table-bordered">
        ...
        $i=1;
        $result = mysqli_query($connect,"SELECT * FROM provisional");
