...
<body>
    <div>
    <?php 
$result2 = mysqli_query($connect,"SELECT DISTINCT `Centre_code` FROM pwd_cand where Weeks = 'W1'"); #fetch provisional candidate centres              
...
{ 
    ...
    <?php      
        $i=1;
        $fetchstud = mysqli_query($connect,"SELECT * FROM pwd_cand where Centre_code ='$gc_code' and Weeks = 'W1'"); #fetch provisional candidate
...
?></table><br><table style="page-break-after:always" width="100%"><tr><td float="left"><b>Notes: Declaration form of Own Scribe / Scribe by GATE is enclosed, if any.</b></td></tr></table>
